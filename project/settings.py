...
DIRECTUS_TEST_TOKEN = os.getenv("DIRECTUS_TEST_TOKEN")
...
JAZZMIN_SETTINGS = {
    # Text
    "site_title": "Directus Hub",
    "site_header": "Admin",
    "site_brand": "Directus Hub",
    "welcome_sign": "Welcome to Directus Hub",
    "copyright": "Powered by Dari Developer / Smooth Software Solutions",
    # Media
